...
function transformProfileToGMBFormat(profile: any) {
  return {
    ...
    attributes: {
      ...
      wheelchairAccessibleParking: profile.accessibility?.wheelchairAccessibleParking,
      wheelchairAccessibleRestroom: profile.accessibility?.wheelchairAccessibleRestroom,
      wheelchairAccessibleSeating: profile.accessibility?.wheelchairAccessibleSeating,
